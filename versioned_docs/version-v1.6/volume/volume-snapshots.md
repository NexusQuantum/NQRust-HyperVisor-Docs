...
1. Choose the volume that you want to take a snapshot of and select **⋮ > Take Snapshot**.
  ...
  ![create-volume-snapshot-1](/img/v1.2/volume-hv/create-volume-snapshot-1.png)

1. Enter a **Name** for the snapshot.

  ![create-volume-snapshot-2](/img/v1.2/volume-hv/create-volume-snapshot-2.png)
...
1. Select **⋮ > Restore**.
  ...
  ![restore-volume-snapshot-1](/img/v1.2/volume-hv/restore-volume-snapshot-1.png)
  
  ![restore-volume-snapshot-2](/img/v1.2/volume-hv/restore-volume-snapshot-2.png)

1. Specify the **Name** of the new volume.

  ![restore-volume-snapshot-3](/img/v1.2/volume-hv/restore-volume-snapshot-3.png)
...
1. If the source volume is not an image volume, you can select a different **StorageClass**. You can not change the **StorageClass** if the source volume is an image volume.
  ...
  ![restore-volume-snapshot-4](/img/v1.2/volume-hv/restore-volume-snapshot-4.png)
