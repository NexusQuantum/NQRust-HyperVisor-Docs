...
![](/img/v1.2/networking-hv/management-network.png)
...
![](/img/v1.2/networking-hv/management-network-mtu.png)
...
![](/img/v1.2/networking-hv/create-vlan-network.png)
...
![](/img/v1.2/networking-hv/create-network-auto.png)

    - Manual: Specify the CIDR and gateway addresses.

![](/img/v1.2/networking-hv/create-network-manual.png)
...
![](/img/v1.2/networking-hv/create-untagged-network.png)
...
![](/img/v1.2/networking-hv/create_vm_networks.png)
