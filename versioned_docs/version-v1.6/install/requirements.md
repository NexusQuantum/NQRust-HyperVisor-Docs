...
description: Outline the Hypervisor installation requirements
---
...
[Live Migration](../vm/live-migration.md) functions correctly only if the CPUs of all physical servers in the [Hypervisor cluster](../getting-started/glossary.md#harvester-cluster) have the same specifications. This requirement applies to all operations that rely on Live Migration functionality, such as automatic VM migration when [Maintenance Mode](../host/host.md#node-maintenance) is enabled.
...
<!-- ### Port Requirements for Hypervisor Nodes

Hypervisor nodes require the following port connections or inbound rules. Typically, all outbound traffic is allowed.
...
| TCP       | 6443                     | Hypervisor management nodes              | Kubernetes API                        |
| TCP       | 9345                     | Hypervisor management nodes              | Kubernetes API                        |
| TCP       | 10252                    | Hypervisor management nodes              | Kube-controller-manager health checks |
| TCP       | 10257                    | Hypervisor management nodes              | Kube-controller-manager secure port   |
| TCP       | 10251                    | Hypervisor management nodes              | Kube-scheduler health checks          |
| TCP       | 10259                    | Hypervisor management nodes              | Kube-scheduler secure port            |
| TCP       | 10250                    | Hypervisor management and compute nodes  | Kubelet                               |
| TCP       | 10256                    | Hypervisor management and compute nodes  | Kube-proxy health checks              |
| TCP       | 10258                    | Hypervisor management nodes              | cloud-controller-manager              |
| TCP       | 10260                    | Hypervisor management nodes              | cloud-controller-manager              |
| TCP       | 9091                     | Hypervisor management and compute nodes  | Canal calico-node felix               |
| TCP       | 9099                     | Hypervisor management and compute nodes  | Canal CNI health checks               |
| UDP       | 8472                     | Hypervisor management and compute nodes  | Canal CNI with VxLAN                  |
| TCP       | 2112                     | Hypervisor management nodes              | Kube-vip                              |
| TCP       | 6444                     | Hypervisor management and compute nodes  | RKE2 agent                            |
| TCP       | 10246/10247/10248/10249 |  Hypervisor management and compute nodes |   Nginx worker process                  |
| TCP       | 8181                     | Hypervisor management and compute nodes  | Nginx-ingress-controller              |
| TCP       | 8444                     | Hypervisor management and compute nodes  | Nginx-ingress-controller              |
| TCP       | 10245                    | Hypervisor management and compute nodes  | Nginx-ingress-controller              |
| TCP       | 80                       | Hypervisor management and compute nodes  | Nginx                                 |
| TCP       | 9796                     | Hypervisor management and compute nodes  | Node-exporter                         |
| TCP       | 30000-32767             |  Hypervisor management and compute nodes  | NodePort port range                   |
| TCP       | 22                       | Hypervisor management and compute nodes  | sshd                                  |
