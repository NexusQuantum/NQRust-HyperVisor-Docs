...
- The webhook denies the upgrade request.
    ...
    ![Upgrade with another default storage class](/img/upgrade/upgrade-with-another-default-storage-class.png)
...
- Add `timeoutSeconds: 600` to the Harvester ManagedChart spec.
    ...
    ![Upgrade with another default storage class workaround](/img/upgrade/upgrade-with-another-default-storage-class-workaround.png)
...
1. Check the partition sizes by running the command `lsblk -o NAME,LABEL,SIZE`.
    ...
    sr0                     1024M
    vda                      250G
    â”œâ”€vda1 COS_GRUB           64M
    â”œâ”€vda2 COS_OEM            64M
    â”œâ”€vda3 COS_RECOVERY        4G
    â”œâ”€vda4 COS_STATE           8G
    â””â”€vda5 COS_PERSISTENT  237.9G
