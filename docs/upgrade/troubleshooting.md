...
![](/img/upgrade/ts_upgrade_phases.png)
...
![](/img/upgrade/ts_status_phase1.png)
...
![](/img/upgrade/ts_status_phase2.png)
...
![](/img/upgrade/ts_status_phase3.png)
...
![](/img/upgrade/ts_status_phase4.png)
...
![The "Enable Logging" checkbox on the upgrade confirmation dialog](/img/upgrade/enable_logging.png)

You can click the **Download Log** button to download the log archive during an upgrade.

![Download the upgrade log archive by clicking the "Download Log" button on the upgrade dialog](/img/upgrade/download_upgradelog_dialog.png)
...
![The upgrade log archive contains all the logs generated by the upgrade-related Pods](/img/upgrade/upgradelog_archive.png)
...
![The upgrade log archive contains all the logs generated by the upgrade-related Pods](/img/upgrade/dismiss_upgrade_to_remove_upgradelog.png)
...
![Disk space not enough error message](/img/upgrade/disk-space-not-enough-error-message.png)
